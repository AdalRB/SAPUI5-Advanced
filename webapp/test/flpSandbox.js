		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Employees",
									"targetURL": "#alfa01employeesv2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"alfa01employeesv2-display": {
								"semanticObject": "alfa01employeesv2",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=alfa01.employeesv2",
									"url": sap.ui.require.toUrl("alfa01/employeesv2")
								}
							}
						}
					}
