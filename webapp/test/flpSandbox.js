			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"alfa01lists-display": {
								"semanticObject": "alfa01lists",
								"action": "display",
								"description": "App list in fiori",
								"title": "AppList",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=alfa01.lists",
									"url": sap.ui.require.toUrl("alfa01/lists")
								}
							}
						}
					}
